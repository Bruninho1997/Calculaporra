...
public class ImcActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView txtresposta, txtresultado;
    EditText txtnum1;
    EditText txtnum2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtresultado = (TextView) findViewById(R.id.txtresultadoIMC);
    ...
    public void calcularImc (View view)
    {
        ...
        String resultadoDoImc = null;

        if (resposta<18.5) resultadoDoImc="Abaixo do peso";
        if (resposta>=18.5&&resposta<24.9) resultadoDoImc = "Peso normal";
        if (resposta>=24.9&&resposta<=29.9) resultadoDoImc = "Sobre peso";
        if (resposta>=30&&resposta<34.9) resultadoDoImc = "Obesidade grau I";
        if (resposta>=35&&resposta<39.9) resultadoDoImc = "Obesidade grau II";
        if (resposta>=40) resultadoDoImc = "Obesidade grau III";
        

            
            txtresultado.setText(String.format(String.valueOf("Resultado : " + resultadoDoImc)));
